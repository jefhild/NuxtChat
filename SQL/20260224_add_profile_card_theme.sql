...
ADD COLUMN IF NOT EXISTS profile_card_theme TEXT NOT NULL DEFAULT 'trading';

UPDATE public.profiles
SET profile_card_theme = 'trading'
WHERE profile_card_theme IS NULL OR btrim(profile_card_theme) = '';
