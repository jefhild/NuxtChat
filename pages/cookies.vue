      ...
      <span style="color: rgb(127, 127, 127)"
        ><span style="color: rgb(89, 89, 89); font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            it visits certain other websites.</span
          ></span
        ></span
      >
    </div>
      ...
      <span style="font-size: 15px; color: rgb(89, 89, 89)"
        ><span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span data-custom-class="body_text"
            ...
            below (please note that the specific </span
          ><span data-custom-class="body_text"
      ...
      ><span style="color: rgb(127, 127, 127)"
        ><span style="color: rgb(89, 89, 89); font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            as access to secure areas.</span
          ></span
        ></span
      >
    </div>
              ...
              >
                ...
                <td style="display: inline-block; margin-left: 5px">
                  <span style="color: #8b93a7; word-break: break-all"
                    ...
                    performance of the consent banner.</span
                  >
                </td>
              </tr>
              <tr
        ...
        ><span style="color: rgb(89, 89, 89); font-size: 15px"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              our Website<bdt class="block-component"></bdt> or opened an email
              including them<bdt class="statement-end-if-in-editor"></bdt>. This
        ...
        ><span style="font-size: 15px; color: rgb(89, 89, 89)"
          ><span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span data-custom-class="body_text"
              ...
              at <bdt class="question">jefhild@oliverwjones.fr</bdt> or by post
              to<bdt class="else-block"></bdt>:</span
            ></span
          ></span
        ></span
      >
    ...
    <div style="line-height: 1.5">
      ...
      ><span data-custom-class="body_text"
        ><span style="font-size: 15px; color: rgb(89, 89, 89)"
          ...
          ><bdt class="statement-end-if-in-editor"></bdt
          ><bdt class="block-component"></bdt> <bdt class="question">19380</bdt
          ><bdt class="statement-end-if-in-editor"></bdt
          ><bdt class="block-component"></bdt
          ><bdt class="block-component"></bdt></span
      ></span>
